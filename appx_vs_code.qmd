...
![](images-vs-code/75c36dbf-2b7a-4fec-866f-4c5416153f3c.png){width="727px"}
...
![](images-vs-code/5451e621-f61d-42f1-9c53-f739cc62d8be.png){width="1112px"}
...
![](images-vs-code/7a0dcede-b838-4683-88aa-d09a8ace90dd.png){width="1105px"}
...
![](images-vs-code/1ea6e9dd-dc66-422a-9487-04b0731a8f6c.png){width="1101px"}
...
![](images-vs-code/357d8eac-2727-44a5-9173-a17db9cabf23.png){width="1285px"}
...
![](images-vs-code/908e8994-9553-46d5-917f-35d7f64f6d72.png){width="1487px"}

and browse to your folder,

![](images-vs-code/3925bb3f-2507-4b46-9b4e-71dbbb84c3e3.png){width="1564px"}
...
![](images-vs-code/1a80dff6-ead1-43c1-94ba-03e8e74e4422.png){width="1188px"}
...
![](images-vs-code/be613d51-ce46-4b61-a806-ea1f0f6e87d6.png){width="1420px"}
...
![](images-vs-code/dfca20e2-2a23-4427-9620-23885bbcfe93.png){width="1416px"}

If you get an error like the one below, check the script name spelling.

![](images-vs-code/5963428b-bf22-4334-99ae-1bbb97300af3.png){width="1450px"}
...
![](images-vs-code/67b39692-4197-41c0-a640-662e1d2719da.png){width="1461px"}
...
![](images-vs-code/6129d1ee-5937-414b-a1a9-5b03b7c68660.png){width="1385px"}
...
![](images-vs-code/233fabbe-e5f5-4422-92ef-7940a76db43e.png){width="1450px"}
...
![](images-vs-code/974bda0b-ccef-4874-87c4-8b68d184f45f.png){width="1386px"}
...
![](images-vs-code/5f602ae6-de5d-437b-8c92-a2d331b6efb2.png){width="1387px"}

There is a keyboard shortcut for the `Run in Python` button: `Ctrl + F5` (or, on a laptop, `Fn + Ctrl + F5`).
The first time you use it you will have to select a "debugger", and the recommendation is fine. 
(It won't actually be used unless you just hit `F5` without the `Ctrl` key.)
...
![](images-vs-code/9f011eff-9814-4677-8682-337f8e335356.png){width="1391px"}
...
![](images-vs-code/aef04a53-7091-4dc2-a426-85a2ffc0ef91.png){width="1199px"}
...
![](images-vs-code/6a98105c-3a61-45ab-bd06-9d1b09b168ed.png){width="1018px"}
...
![](images-vs-code/671eb382-7370-43b5-80d4-d3115716ce11.png){width="1290px"}
