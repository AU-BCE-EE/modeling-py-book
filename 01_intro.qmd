...
Parameter values may be determined from fitting the model (or a simpler one) to measurements, but a mechanistic approach would still better represent the underlying physical, chemical, and biological processes.
...
For example, even application of the model (@eq-methmode) to a larger reactor would fail.
