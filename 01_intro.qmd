...
@eq-coffee-ge1 is actually a *differential equation* because it describes the rate of change in coffee temperature $T$ over time.
It is also the *governing equation* or *GE* for this model, or that complete equation that describes the system.
...
They can also provide insight into model behavior at the mathematical model stage.
@eq-coffee-sol1 tells us that $T$ will start at $T_0$ and drop toward $T_{air}$, quickly at first but then more and more slowly.
These inferences require some experience with symbolic mathematics.

So why not use only analytical solutions?
Because it is not possible in most cases.
...
In other cases the steady-state solution is much more interesting and useful.
