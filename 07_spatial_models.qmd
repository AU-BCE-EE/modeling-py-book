...
This equation enforces the Neumann boundary condition at the top boundary, L. Earlier in @ex-pipe_model, we avoided the whole ghost point by using backward difference instead. But 
