...
The Dirictlet BC is also referred to as a boundary condition of the first type. It describes the state variable value at the boundary. We already used it in the @fig-pipe_discretize1 example, where we ficed the temperature at the left boundary to $10 \degC$. The Dirichlet BC can be mathematically formulated as
