...
Model fit statistics summarize the correspondence between measurements and model output.
Several statistics exist, but we'll focus on three that are useful or common.
