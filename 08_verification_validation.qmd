...
![Graphical validation of a soil microbiology model from @zhang-denit-mod-2023. Each plot shows a different variable. Measurements are shown as points, and model output as lines.](paper-images/denitmod1.png){#fig-denitmod1 fig-alt="Denitrification model validation."}
