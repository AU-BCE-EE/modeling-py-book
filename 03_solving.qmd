...
1. Assume you have a big water cubic tank, say 10 $\text{m}^3$, that is draining through a pipe at the bottom under the force of gravity.
...
1. Implement a complete slurry cooling model in Python.
   The model could be steady-state or dynamic.
   And you are free to use an analytical or numeric approach.
   Using reasonable parameter estimates, generate and plot some predictions.
