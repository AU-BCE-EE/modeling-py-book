...
![Graphical validation of a pesticide volatilization model from @yates_simulating_2006. Measurements are shown as points, and model output as lines.](paper-images/pestmod1.png){#fig-pestmod1 fig-alt="Volatilization of a pesticide."}
